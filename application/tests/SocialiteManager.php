...
use Laravel\Socialite\Two\DGPProvider;
...
class SocialiteManager extends Manager implements Contracts\Factory
{
     ...
     */
    protected function createDGPDriver()
    {
        $config = $this->config->get('services.DGP');

        return $this->buildProvider(
            DGPProvider::class, $config
        );
    }
    ...
    public function buildProvider($provider, $config)
    {
        ...
        // dd($this->container->make('request'), $config['client_id'],
