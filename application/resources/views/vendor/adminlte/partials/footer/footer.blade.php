<footer class="main-footer shadow-lg" style="border-top: 2px solid #6c757d;">
    <div class="container">
        <div class="row">
            <!-- Contact Information -->
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="https://sucemnet.eb.mil.br/cn_login" target="_blank" class="text-muted">SucemNet</a></li>
                    <li><a href="https://sucem-dcem.eb.mil.br/" target="_blank" class="text-muted">Sucem (Interno)</a></li>
                    <li><a href="https://si.badmqgex.eb.mil.br/" target="_blank" class="text-muted">Sistema de Arranchamento da B ADM QGEX</a></li>
                    <li><a href="https://servico.badmqgex.eb.mil.br/" target="_blank" class="text-muted">Sistema de Serviço da B ADM QGEX</a></li>
                </ul>
            </div>
            <div class="col-md-">
